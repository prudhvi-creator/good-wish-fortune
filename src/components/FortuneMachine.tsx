...
export function FortuneMachine() {
  ...
  return (
    <div className="page-shell">
      ...
      <footer className="site-footer"><a className="footer-brand" href="#">✳ good wish</a><p>A little make-believe. A very real smile.</p><span>MADE WITH <Heart size={12} /> & A CUP OF CHAI By Prudhvi </span></footer>
